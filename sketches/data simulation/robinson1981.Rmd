...
As to the priors, the $\mathcal N(\log(5), 0.5)$ prior for $\beta_0$ is meant to concentrate the intercepts for the first phase, B1, in the middle single-digit integers. If you exponentiate, here are its median and 95% range on the count space:
